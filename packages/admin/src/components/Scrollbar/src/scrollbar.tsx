  ...
  setup(props, { slots, emit }) {
    ...
    return () => (
      <div ref={scrollbarRef} class={prefixCls}>
        <div
          ref={wrapRef}
          class={[props.wrapClass, prefixCls + '__wrap', props.native ? '' : prefixCls + '__wrap--hidden-default']}
          style={style.value}
          onScroll={handleScroll}
        >
          <props.tag ref={resizeRef} class={[prefixCls + '__view', props.viewClass]} style={props.viewStyle}>
            {slots.default?.()}
          </props.tag>
        </div>
        {!props.native
